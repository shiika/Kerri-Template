...
function () {
  ...
  _createClass(Initializer, [{
    ...
    value: function load(self, options, elementId) {
      ...
      self.options = _objectSpread({}, _defaults.default, options); // attribute to type into
      ...
      self.pause = {
        ...
        typewrite: true,
        curString: '',
        curStrPos: 0 // When the typing is complete (when not looped)
...
$(document).ready(function () {
  ...
  var typed = new _typed.default(".element", options); // navbar scroll animation
...
},{"./typed.js":5}],5:[function(require,module,exports){
"use strict";
...
},{"./html-parser.js":2,"./initializer.js":3}]},{},[4]);
